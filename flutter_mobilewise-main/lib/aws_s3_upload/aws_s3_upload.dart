...
import 'model/policy_params_for_upload_image.dart';
...
class AwsS3 {
  ...
  static Future<String?> uploadFile({
    ...
    final policy = PolicyParamsForUploadImage.fromS3PresignedPost(
      uploadKey,
      bucket,
      accessKey,
      15,
    ...
    req.fields['acl'] = Util.instance.aclToString(acl);
