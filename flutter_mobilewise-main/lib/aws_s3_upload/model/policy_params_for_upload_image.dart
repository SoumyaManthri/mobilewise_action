...
class PolicyParamsForUploadImage {
  String expiration;
  String region;
  ACL acl;
  String bucket;
  ...
  factory PolicyParamsForUploadImage.fromS3PresignedPost(
    String key,
    String bucket,
    String accessKeyId,
    int expiryMinutes,
    ...
    return PolicyParamsForUploadImage(
      key,
      bucket,
      datetime,
      expiration,
  ...
  String toString() {
    ...
    final payload = {
      ...
      "conditions": [
        ...
        {"acl": "${Util.instance.aclToString(acl)}"},
